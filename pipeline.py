...
def build_video_prompt(visual_prompt: str) -> str:
    """Prepends the fixed PS2-style block. Shots only carry the scene-specific part."""
    return f"{ART_STYLE_BLOCK} {visual_prompt}".strip()
